...
for i in range(randint(10, 50)): #randomizes how many times the loop is run
    ...
    for i in range(randint(1, 50) ): #randomizes how long a single line goes for
        ...
        crystal.right(randint(-10, 10)*45) #randomizes which angle the turtle turns to, but in multiples of 45 degrees.
        #This is because due to the types of bonds in DNA they tend to have angles that are multiples of 45 and 90
done()