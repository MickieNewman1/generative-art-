...
for i in range(randint(10, 50)): #randomizes how many times the loop is run
    ...
    for i in range(randint(1, 50) ): #randomizes how long a single line goes for
        ...
        crystal.right(randint(-10, 10)*90) #randomizes which angle the turtle turns to, but in multiples of 90 degrees.
        #This is because due to the types of bonds in octahedral structures tend to have angles that are multiples of 90 degrees
done()