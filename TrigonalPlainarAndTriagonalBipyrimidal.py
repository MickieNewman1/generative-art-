...
for i in range(randint(10, 50)): #randomizes how many times the loop is run
    ...
    for i in range(randint(1, 50) ): #randomizes how long a single line goes for
        ...
        crystal.right(randint(-10, 10)*120) #randomizes which angle the turtle turns to, but in multiples of 120 degrees the bond angles for trigonal plainar triagonal bipyrimidal.
